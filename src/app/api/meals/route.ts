...
export async function PATCH(req: NextRequest) {
  try {
    ...
    // Build partial update payload — only fields present in body
...
export async function POST(req: NextRequest) {
  try {
    ...
    const meal_type =
      typeof mealTypeRaw === 'string' && mealTypeRaw ? mealTypeRaw : 'Dinner';
    ...
    const source_url =
      typeof sourceUrlRaw === 'string' ? sourceUrlRaw : undefined;
