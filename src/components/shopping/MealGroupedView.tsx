    ...
    return (
        <div className="space-y-4">
                    ...
                    >
                        ...
                        <div className="px-4 py-3 bg-gray-50 border-b border-gray-100">
                            <h2 className="font-semibold text-gray-900">
                                {dayName}
                                <span className="text-sm font-normal text-gray-500 ml-2">{dateFormatted}</span>
                            </h2>
                        </div>
                                ...
                                return (
                                    <div key={mealType} className="px-4 py-3">
                                        <div className="flex items-center gap-2 mb-2">
                                            <span className="text-xs font-medium uppercase text-gray-500">{mealType}</span>
            ...
            {sortedDates.length === 0 && (
                <p className="text-center text-gray-500 py-8">No meals found in this plan.</p>
            )}
        </div>
    );
}
