...
export function DropConfirmationDialog({
    ...
    return (
        <Dialog open={isOpen} onOpenChange={(open) => !open && onCancel()}>
            <DialogContent className="sm:max-w-md" data-testid="drop-confirmation-dialog">
                <DialogHeader>
                ...
                <div className="space-y-4 py-4">
                    ...
                    <div className="flex items-center gap-3 p-3 bg-amber-50 rounded-lg border border-amber-200">
                        ...
                        <div>
                            <p className="text-xs text-amber-600 font-medium">Slot occupied by</p>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    >
                        ...
                        Swap
                        <kbd className="ml-2 px-1.5 py-0.5 text-xs bg-blue-700 rounded">S</kbd>
                    </Button>
                    <Button
                        onClick={onReplace}
                        variant="outline"
                    ...
                    >
                        ...
                        Replace
                        <kbd className="ml-2 px-1.5 py-0.5 text-xs bg-gray-200 rounded">R</kbd>
                    </Button>
                </div>
